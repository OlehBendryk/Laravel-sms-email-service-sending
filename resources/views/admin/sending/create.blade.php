    ...
    <div class="container">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    {{ Form::label('messenger', 'Messenger', ['class' => 'col-4 text-md-right']) }}
                    {{ Form::select('messenger', [0 => 'Email', 1 => 'SMS'], 0, ['class' => "form-control col-8 mb-2" .  ($errors->has('messenger') ? 'is-invalid' : ''), 'required']) }}
