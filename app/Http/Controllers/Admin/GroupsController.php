...
class GroupsController extends BaseController
{
    ...
    {
        $customers = $this->customerRepository->getFullName()->toArray();
    ...
    public function edit(int $id)
    {
        ...
        $customersGroup = $this->groupRepository->getCustomersForGroupById($id);

        return view('admin.groups.edit')
            ->with('group', $group)
            ->with('customersGroup', $customersGroup)
            ->with('customers', $customers);
    }
